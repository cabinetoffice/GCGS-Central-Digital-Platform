...
public class DataServiceTests
{
    ...
    public async Task ShouldMapFormAnswerSetsForPdf()
    {
        ...
        exclusionsSection.QuestionAnswers.Should().Contain(qa => qa.Item1 == "What is the financial year end date for the information you uploaded?" && qa.Item2 == DateTime.Today.ToString("dd MMMM yyyy"));
