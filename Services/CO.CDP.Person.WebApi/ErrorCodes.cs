...
public static class ErrorCodes
{
    public static readonly Dictionary<Type, (int, string)> Exception4xxMap = new()
    {
        ...
        { typeof(DuplicateGuidException), (StatusCodes.Status400BadRequest, "PERSON_GUID_ALREADY_EXISTS") },
        { typeof(DuplicateEmailException), (StatusCodes.Status400BadRequest, "PERSON_EMAIL_ALREADY_EXISTS") },
