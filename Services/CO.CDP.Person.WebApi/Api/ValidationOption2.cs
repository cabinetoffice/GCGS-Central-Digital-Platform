...
namespace CO.CDP.Person.WebApi.Api.ValidationSpikeTwo
{
    ...
    public static class EndpointExtensions
    {
        ...
        public static void UsePersonEndpoints(this WebApplication app)
        {
            ...
            app.MapPost("/persons", async (HttpContext http, IValidator<NewPerson> validator, [FromBody] NewPerson newPerson) =>
                {
                    FluentValidation.Results.ValidationResult results = await validator.ValidateAsync(newPerson);
                    if (!results.IsValid)
                    {
