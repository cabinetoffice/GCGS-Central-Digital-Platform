    ...
    public partial class UpdateAnnotationsForTrustsTrustees : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                .Annotation("Npgsql:Enum:connected_entity_individual_and_trust_category_type", "person_with_significant_control_for_individual,director_or_individual_with_the_same_responsibilities_for_individual,any_other_individual_with_significant_influence_or_control_for_individual,person_with_significant_control_for_trust,director_or_individual_with_the_same_responsibilities_for_trust,any_other_individual_with_significant_influence_or_control_for_trust")
