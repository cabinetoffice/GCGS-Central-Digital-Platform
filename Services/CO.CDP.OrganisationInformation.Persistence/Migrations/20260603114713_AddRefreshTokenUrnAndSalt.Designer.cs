...
namespace CO.CDP.OrganisationInformation.Persistence.Migrations
{
    ...
    [Migration("20260603114713_AddRefreshTokenUrnAndSalt")]
    partial class AddRefreshTokenUrnAndSalt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CO.CDP.OrganisationInformation.Persistence.Application", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CO.CDP.OrganisationInformation.Persistence.ApplicationPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ApplicationId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_application_permissions_application_id_name");

                    b.ToTable("application_permissions", (string)null);
                });

            modelBuilder.Entity("CO.CDP.OrganisationInformation.Persistence.ApplicationRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("Guid")
                        .IsUnique()
                        .HasDatabaseName("ix_application_roles_guid");
            ...
            modelBuilder.Entity("CO.CDP.OrganisationInformation.Persistence.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CO.CDP.OrganisationInformation.Persistence.OrganisationApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_organisation_applications");

                    b.HasIndex("ApplicationId")
                        .HasDatabaseName("ix_organisation_applications_application_id");

                    b.HasIndex("OrganisationId", "ApplicationId")
                        .IsUnique()
                        .HasDatabaseName("ix_organisation_applications_organisation_id_application_id");
            ...
            modelBuilder.Entity("CO.CDP.OrganisationInformation.Persistence.UserApplicationAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_user_application_assignments");

                    b.HasIndex("OrganisationApplicationId")
                        .HasDatabaseName("ix_user_application_assignments_organisation_application_id");

                    b.HasIndex("PersonId", "OrganisationApplicationId")
                        .IsUnique()
                        .HasDatabaseName("ix_user_application_assignments_person_id_organisation_applica");
            ...
            modelBuilder.Entity("RolePermission", b =>
                {
                    ...
                    b.HasKey("ApplicationPermissionId", "ApplicationRoleId")
                        .HasName("pk_role_permissions");

                    b.HasIndex("ApplicationRoleId")
                        .HasDatabaseName("ix_role_permissions_application_role_id");

                    b.ToTable("role_permissions", (string)null);
                });

            modelBuilder.Entity("UserApplicationAssignmentRole", b =>
                {
                    b.Property<int>("ApplicationRoleId")
                        .HasColumnType("integer")
                        .HasColumnName("application_role_id");
                    ...
                    b.Property<int>("UserApplicationAssignmentId")
                        .HasColumnType("integer")
                        .HasColumnName("user_application_assignment_id");

                    b.HasKey("ApplicationRoleId", "UserApplicationAssignmentId")
                        .HasName("pk_user_application_assignment_roles");

                    b.HasIndex("UserApplicationAssignmentId")
                        .HasDatabaseName("ix_user_application_assignment_roles_user_application_assignme");

                    b.ToTable("user_application_assignment_roles", (string)null);
                });

            modelBuilder.Entity("CO.CDP.OrganisationInformation.Persistence.ApplicationPermission", b =>
                {
                    b.HasOne("CO.CDP.OrganisationInformation.Persistence.Application", "Application")
                        .WithMany("Permissions")
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_application_permissions_applications_application_id");
            ...
            modelBuilder.Entity("CO.CDP.OrganisationInformation.Persistence.OrganisationApplication", b =>
                {
                    b.HasOne("CO.CDP.OrganisationInformation.Persistence.Application", "Application")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_organisation_applications_applications_application_id");
                    ...
                    b.HasOne("CO.CDP.OrganisationInformation.Persistence.Organisation", "Organisation")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_organisation_applications_organisations_organisation_id");
            ...
            modelBuilder.Entity("CO.CDP.OrganisationInformation.Persistence.UserApplicationAssignment", b =>
                {
                    b.HasOne("CO.CDP.OrganisationInformation.Persistence.OrganisationApplication", "OrganisationApplication")
                        .WithMany()
                        .HasForeignKey("OrganisationApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_application_assignments_organisation_applications_orga");
                    ...
                    b.HasOne("CO.CDP.OrganisationInformation.Persistence.Person", "Person")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_application_assignments_persons_person_id");
            ...
            modelBuilder.Entity("RolePermission", b =>
                {
                    b.HasOne("CO.CDP.OrganisationInformation.Persistence.ApplicationPermission", null)
                        .WithMany()
                        .HasForeignKey("ApplicationPermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_role_permissions_application_permissions_application_permis");

                    b.HasOne("CO.CDP.OrganisationInformation.Persistence.ApplicationRole", null)
                        .WithMany()
                        .HasForeignKey("ApplicationRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_role_permissions_application_roles_application_role_id");
                });
            ...
            modelBuilder.Entity("UserApplicationAssignmentRole", b =>
                {
                    b.HasOne("CO.CDP.OrganisationInformation.Persistence.ApplicationRole", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_application_assignment_roles_application_roles_applica");

                    b.HasOne("CO.CDP.OrganisationInformation.Persistence.UserApplicationAssignment", null)
                        .WithMany()
                        .HasForeignKey("UserApplicationAssignmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_application_assignment_roles_user_application_assignme");
                });
