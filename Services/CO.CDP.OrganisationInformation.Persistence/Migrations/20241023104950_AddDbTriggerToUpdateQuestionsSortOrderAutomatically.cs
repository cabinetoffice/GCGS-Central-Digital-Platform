...
{
    /// <inheritdoc />
    public partial class AddDbTriggerToUpdateQuestionsSortOrderAutomatically : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql($@"
                ...
                CREATE TRIGGER after_update_next_question_id_trigger
                AFTER UPDATE OF next_question_id ON form_questions
                EXECUTE FUNCTION update_sort_order();

                CREATE TRIGGER after_update_sort_order_trigger
                AFTER UPDATE OF sort_order ON form_questions
                EXECUTE FUNCTION update_sort_order();

                CREATE TRIGGER after_insert_form_questions_trigger
                AFTER INSERT ON form_questions
                EXECUTE FUNCTION update_sort_order();
            ");
        }
