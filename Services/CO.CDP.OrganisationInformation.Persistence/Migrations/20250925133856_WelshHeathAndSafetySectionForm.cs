...
namespace CO.CDP.OrganisationInformation.Persistence.Migrations
{
    ...
    public partial class WelshHeathAndSafetySectionForm : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var healthAndSafety02GroupId = new Guid("12345678-1234-1234-1234-123456789002"); // Group 2: HealthAndSafety_04-05
            var healthAndSafety03GroupId = new Guid("12345678-1234-1234-1234-123456789003"); // Group 3: HealthAndSafety_06-07
            var healthAndSafety04GroupId = new Guid("12345678-1234-1234-1234-123456789004"); // Group 4: HealthAndSafety_08-09
            var healthAndSafety05GroupId = new Guid("12345678-1234-1234-1234-123456789005"); // Group 5: HealthAndSafety_10-11
            ...
            var healthAndSafety02GroupingMultiQuestionJsonFragment = $"\"grouping\": {{ \"id\": \"{healthAndSafety02GroupId}\", \"page\": true, \"checkYourAnswers\": true, \"summaryTitle\": \"{healthAndSafety02GroupSummaryTitle}\" }}";
            var healthAndSafety03GroupingSingleQuestionJsonFragment = $"\"grouping\": {{ \"id\": \"{healthAndSafety03GroupId}\", \"page\": false, \"checkYourAnswers\": true, \"summaryTitle\": \"{healthAndSafety03GroupSummaryTitle}\" }}";
            ...
            var healthAndSafety04GroupingJsonFragment = $"\"grouping\": {{ \"id\": \"{healthAndSafety04GroupId}\", \"page\": false, \"checkYourAnswers\": true, \"summaryTitle\": \"{healthAndSafety04GroupSummaryTitle}\" }}";
            var healthAndSafety05GroupingJsonFragment = $"\"grouping\": {{ \"id\": \"{healthAndSafety05GroupId}\", \"page\": false, \"checkYourAnswers\": true, \"summaryTitle\": \"{healthAndSafety05GroupSummaryTitle}\" }}";
            ...
            var healthAndSafety02MultiQuestionGroupedOptionsJson = $"'{{ {healthAndSafety02GroupingMultiQuestionJsonFragment} }}'";
            var healthAndSafety03SingleQuestionGroupedOptionsJson  = $"'{{ {healthAndSafety03GroupingSingleQuestionJsonFragment} }}'";
            var healthAndSafety03MultiQuestionGroupedOptionsJson = $"'{{ {healthAndSafety03GroupingMultiQuestionJsonFragment} }}'";
            var healthAndSafety04GroupedOptionsJson = $"'{{ {healthAndSafety04GroupingJsonFragment} }}'";
            var healthAndSafety05GroupedOptionsJson = $"'{{ {healthAndSafety05GroupingJsonFragment} }}'";

            // JSON for HealthAndSafety_08 question options with inset text
            var healthAndSafety08OptionsWithInsetTextJson = $"'{{\"layout\": {{\"button\" : {{\"beforeButtonContent\": \"WelshHealthAndSafetyQuestion_08_CustomInsetText\"}}}}, {healthAndSafety04GroupingJsonFragment} }}'";

            // JSON for HealthAndSafety_11 question options with inset text
            var healthAndSafety11OptionsWithInsetTextJson = $"'{{\"layout\": {{\"button\" : {{\"beforeButtonContent\": \"WelshHealthAndSafetyQuestion_11_CustomInsetText\"}}}}, {healthAndSafety05GroupingJsonFragment} }}'";
...
migrationBuilder.Sql($@"
        DO $$
                ...
                BEGIN
                    ...
                    INSERT INTO form_questions (guid, next_question_id, next_question_alternative_id, section_id, ""type"", is_required, title, description, ""options"",  caption, summary_title, ""name"", sort_order)
                    VALUES('{Guid.NewGuid()}', NULL, NULL, sectionId, 0, true, 'WelshHealthAndSafetyQuestion_05_Title', NULL, " + healthAndSafety02MultiQuestionGroupedOptionsJson + $@", NULL, '', '_WelshHealthAndSafetyQuestion05', 5)
                    ...
                    INSERT INTO form_questions (guid, next_question_id, next_question_alternative_id, section_id, ""type"", is_required, title, description, ""options"",  caption, summary_title, ""name"", sort_order)
                    VALUES('{Guid.NewGuid()}', NULL, NULL, sectionId, 0, true, 'WelshHealthAndSafetyQuestion_07_Title', NULL, " + healthAndSafety03MultiQuestionGroupedOptionsJson + $@", NULL, '', '_WelshHealthAndSafetyQuestion07', 10)
                    ...
                    INSERT INTO form_questions (guid, next_question_id, next_question_alternative_id, section_id, ""type"", is_required, title, description, ""options"",  caption, summary_title, ""name"", sort_order)
                    VALUES('{Guid.NewGuid()}', NULL, NULL, sectionId, 3, true, 'WelshHealthAndSafetyQuestion_09_Title', NULL, " + healthAndSafety04GroupedOptionsJson + $@", NULL, 'WelshHealthAndSafetyQuestion_09_SummaryTitle', '_WelshHealthAndSafetyQuestion09', 15)
                    RETURNING id INTO q9Id;

                    INSERT INTO form_questions (guid, next_question_id, next_question_alternative_id, section_id, ""type"", is_required, title, description, ""options"",  caption, summary_title, ""name"", sort_order)
                    VALUES('{Guid.NewGuid()}', NULL, NULL, sectionId, 2, false, 'WelshHealthAndSafetyQuestion_10_Title', 'WelshHealthAndSafetyQuestion_10_Description', " + healthAndSafety05GroupedOptionsJson + $@", NULL, 'WelshHealthAndSafetyQuestion_10_SummaryTitle', '_WelshHealthAndSafetyQuestion10', 16)
