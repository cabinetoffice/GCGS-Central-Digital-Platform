...
{
    public DataSharingProfile(IIdentifierSchemes identifierSchemes)
    {
        ...
        CreateMap<Organisation.Identifier, Identifier>()
            ...
            .ForMember(m => m.Uri, o => o.MapFrom(m => identifierSchemes.GetRegistryUri(m.Scheme, m.IdentifierId)));
