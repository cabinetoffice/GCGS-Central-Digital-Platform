...
namespace CO.CDP.EntityVerification.Migrations
{
    ...
    [Migration("20241118101918_countryidentifiers")]
    partial class countryidentifiers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CO.CDP.EntityVerification.Persistence.CountryIndentifiers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasKey("Id")
                        .HasName("pk_country_identifiers");

                    b.HasIndex("Scheme")
                        .HasDatabaseName("ix_country_identifiers_scheme");

                    b.ToTable("country_identifiers", "entity_verification");
                });
