...
build-docker: ## Build Docker images sequentially to reduce memory usage
	...
	@DOCKER_BUILDKIT_INLINE_CACHE=1 docker compose build --memory=2g --build-arg VERSION=$(VERSION) av-scanner scheduled-worker outbox-processor-organisation outbox-processor-entity-verification outbox-processor-person-user-management
