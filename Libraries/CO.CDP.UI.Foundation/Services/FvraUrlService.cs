...
/// <summary>
/// Configuration options for the FVRA URL service
/// </summary>
public class FvraUrlOptions : ServiceUrlOptions
{
    public FvraUrlOptions()
    {
        SessionKey = "FvraServiceOrigin";
    }
}
public class FvraUrlService : UrlServiceBase, IFvraUrlService
{
    /// <summary>
    /// Initialises a new instance of the FvraUrlService
    /// </summary>
    /// <param name="options">FVRA URL options</param>
    ...
    public FvraUrlService(
        FvraUrlOptions options,
    ...
    /// <summary>
    /// Builds a URL to a FVRA service endpoint with optional additional query parameters
    /// </summary>
    ...
    /// <returns>The complete URL to the FVRA Tool service endpoint</returns>
