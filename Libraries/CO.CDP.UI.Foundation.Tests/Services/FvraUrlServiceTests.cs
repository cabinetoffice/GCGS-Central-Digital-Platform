...
public class FvraUrlServiceTests
{
    ...
    public FvraUrlServiceTests()
    {
        ...
        _fvraUrlOptions = new FvraUrlOptions
        {
            ServiceBaseUrl = "https://fvra-service.example.com",
            SessionKey = "FvraServiceOrigin"
        };
    ...
    {
        var service = new FvraUrlService(_fvraUrlOptions, _mockHttpContextAccessor.Object);

        var url = service.BuildUrl("/test-endpoint");

        url.Should().Be("https://fvra-service.example.com/test-endpoint?language=en_GB");
    }
    ...
    public void BuildUrl_ShouldIncludeOrganisationId_WhenProvided()
    {
        ...
        url.Should()
            .Be(
                "https://fvra-service.example.com/test-endpoint?language=en_GB&organisation_id=12345678-1234-1234-1234-123456789012");
    }
    ...
    public void BuildUrl_ShouldIncludeRedirectUrl_WhenProvided()
    {
        ...
        url.Should()
            .Be(
                "https://fvra-service.example.com/test-endpoint?language=en_GB&redirectUri=https%3A%2F%2Freturn.example.com");
    }
    ...
    public void BuildUrl_ShouldIncludeCookieAcceptance_WhenCookieServiceProvided()
    {
        ...
        url.Should().Be("https://fvra-service.example.com/test-endpoint?language=en_GB&cookies_accepted=true");
    }

    [Fact]
    public void BuildUrl_ShouldUseSessionOrigin_WhenAvailable()
    {
        _sessionItems.Add("FvraServiceOrigin", "https://session-fvra.example.com");
        var service = new FvraUrlService(_fvraUrlOptions, _mockHttpContextAccessor.Object);

        var url = service.BuildUrl("/test-endpoint");

        url.Should().Be("https://session-fvra.example.com/test-endpoint?language=en_GB");
    }

    [Fact]
    public void BuildUrl_ShouldThrowException_WhenNoServiceUrlConfigured()
    {
        var emptyOptions = new FvraUrlOptions
        {
            ServiceBaseUrl = null!,
            SessionKey = "FvraServiceOrigin"
        };
        ...
        Action action = () =>
        {
            _ = new FvraUrlService(emptyOptions, _mockHttpContextAccessor.Object);
        };
    ...
    {
        var optionsWithTrailingSlash = new FvraUrlOptions
        {
            ServiceBaseUrl = "https://fvra-service.example.com/",
            SessionKey = "FvraServiceOrigin"
        };
        var service = new FvraUrlService(optionsWithTrailingSlash,
    ...
    public void BuildUrl_ShouldWorkWithWelshLanguage()
    {
        ...
        try
        {
            ...
            url.Should().Be("https://fvra-service.example.com/test-endpoint?language=cy");
        }
        finally
        {
    ...
    public void BuildUrl_ShouldIncludeCorrectCookieAcceptanceValue(CookieAcceptanceValues cookieValue, string expectedValue)
    {
        ...
        url.Should()
            .Be($"https://fvra-service.example.com/test-endpoint?language=en_GB&cookies_accepted={expectedValue}");
    }
