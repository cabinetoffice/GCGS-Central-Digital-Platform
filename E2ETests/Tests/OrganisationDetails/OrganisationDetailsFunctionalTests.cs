...
namespace E2ETests.OrganisationDetails
{
    public class OrganisationDetailsFunctionalTests : OrganisationDetailsBaseTest
    {
        ...
        {
            TestContext.WriteLine("🔹 Scenario: Completing organisation details journey using UK addresses");
            ...
            TestContext.WriteLine("✅ Completed Organisation Details Journey with UK address");
        }
        ...
        {
            TestContext.WriteLine("🔹 Scenario: Completing journey with non-UK registered address");
            ...
            TestContext.WriteLine("✅ Completed Organisation Details Journey with non-UK registered address");
        }
        ...
        {
            TestContext.WriteLine("🔹 Scenario: Completing journey with non-UK postal address");
        ...
        public async Task CompleteOrganisationDetailsJourney_AsIndividualSupplier()
        {
            ...
            TestContext.WriteLine("✅ Completed Organisation Details Journey as Individual");
        }
    }
}
