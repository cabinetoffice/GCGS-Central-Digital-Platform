...
public class CyberEssentialsTests : OrganisationDetailsBaseTest
{
    ...
    public async Task ShouldCompleteTheCyberEssentialsLongModuleJourney()
    {
        ...
        await InteractionUtilities.PageTitleShouldBe("Submitting your Cyber Essentials certification scheme information - Find a Tender - GOV.UK");
        await InteractionUtilities.ClickButtonByText("Continue");
        await InteractionUtilities.PageTitleShouldBe("Do you meet the Cyber Essentials certification requirements? - Find a Tender - GOV.UK");
        await InteractionUtilities.ClickRadioButtonByText("Yes");
        await InteractionUtilities.ClickButtonByText("Continue");
        await InteractionUtilities.PageTitleShouldBe("When will you meet the Cyber Essentials certification requirements? - Find a Tender - GOV.UK");
        await InteractionUtilities.ClickRadioButtonByText("Yes");
        await InteractionUtilities.ClickButtonByText("Continue");
        await InteractionUtilities.PageTitleShouldBe("Upload evidence of your Cyber Essentials certification (or equivalent) - Find a Tender - GOV.UK");
        await InteractionUtilities.UploadFile();
        await InteractionUtilities.ClickButtonByText("Continue");
        await InteractionUtilities.PageTitleShouldBe("Enter the expiry date of your Cyber Essentials certification (or equivalent) - Find a Tender - GOV.UK");
        await InteractionUtilities.EnterDate(01, 06,2017);
        await InteractionUtilities.ClickButtonByText("Continue");
        await InteractionUtilities.PageTitleShouldBe("Do you meet the Cyber Essentials Plus certification requirements? - Find a Tender - GOV.UK");
        await InteractionUtilities.ClickRadioButtonByText("Yes");
        await InteractionUtilities.ClickButtonByText("Continue");
        await InteractionUtilities.PageTitleShouldBe("When will you meet the Cyber Essentials Plus certification requirements? - Find a Tender - GOV.UK");
        await InteractionUtilities.ClickRadioButtonByText("Yes");
        await InteractionUtilities.ClickButtonByText("Continue");
        await InteractionUtilities.PageTitleShouldBe("Upload evidence of your Cyber Essentials Plus certification (or equivalent) - Find a Tender - GOV.UK");
        await InteractionUtilities.UploadFile();
        await InteractionUtilities.ClickButtonByText("Continue");
        await InteractionUtilities.PageTitleShouldBe("Enter the expiry date of your Cyber Essentials Plus certification (or equivalent) - Find a Tender - GOV.UK");
