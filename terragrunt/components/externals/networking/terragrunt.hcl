terraform {
  source = local.global_vars.locals.environment == "integration" ? null : "../../../modules//externals/networking"
}
...
locals {
  ...
  service_vars = read_terragrunt_config(find_in_parent_folders("externals.hcl"))
