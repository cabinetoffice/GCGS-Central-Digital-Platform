locals {
  ...
  environments = {
    ...
    staging = {
      ...
      pinned_service_version_fts          = "2.9.4"
      pinned_service_version              = "1.3.1"
      postgres_instance_type              = "db.t4g.micro"
    ...
    integration = {
      ...
      grafana_db_multi_az                 = false
      pinned_service_version_cfs          = "1.1.0"
      pinned_service_version_fts          = "2.9.6"
      pinned_service_version              = "1.3.1"
      postgres_instance_type              = "db.t4g.micro"
      postgres_aurora_instance_type       = "db.r5.large"
      private_subnets = [
    ...
    production = {
      ...
      grafana_db_multi_az                 = true
      pinned_service_version_cfs          = "1.1.0"
      pinned_service_version_fts          = "2.9.5"
      pinned_service_version              = "1.3.1"
      postgres_instance_type              = "db.t4g.micro"
      postgres_aurora_instance_type       = "db.r5.8xlarge"
      postgres_aurora_instance_type_ev    = "db.r5.4xlarge"
  ...
  service_configs_base = {
    ...
    tenant                               = {}
    user_journey_monitoring              = { desired_count = local.environment == "production" ? 1 : (local.environment == "development" ? 1 : 0), cpu = 4096, memory = 8192 }
  ...
  service_configs_common = {
    ...
    e2e_nightly_dev                      = { cluster = "sirsi-php", type = "one-off-task", name = "e2e-nightly-dev" }
    ...
    fts_notice_publish_worker_dotnet     = { cluster = "fts",       type = "service",      name = "fts-notice-publish-worker-dotnet" }
