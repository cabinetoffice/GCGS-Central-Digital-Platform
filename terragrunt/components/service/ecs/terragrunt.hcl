...
dependency service_database {
  ...
  mock_outputs = {
    ...
    fts_proxy_endpoint                                = "mock"
    cfs_proxy_endpoint                                = "mock"
...
inputs = {
  ...
  db_cfs_proxy_endpoint                           = dependency.service_database.outputs.cfs_proxy_endpoint
  ...
  db_fts_proxy_endpoint                           = dependency.service_database.outputs.fts_proxy_endpoint
  ...
  db_find_a_tender_cluster_address                = dependency.service_database.outputs.find_a_tender_cluster_address
  db_find_a_tender_cluster_credentials_arn        = dependency.service_database.outputs.find_a_tender_cluster_credentials_arn
  db_find_a_tender_cluster_credentials_kms_key_id = dependency.service_database.outputs.find_a_tender_cluster_credentials_kms_key_id
  db_find_a_tender_cluster_name                   = dependency.service_database.outputs.find_a_tender_cluster_name
