...
inputs = {
  ...
  private_beta_domain         = dependency.core_networking.outputs.private_beta_domain
  private_beta_hosted_zone_id = dependency.core_networking.outputs.private_beta_hosted_zone_id
