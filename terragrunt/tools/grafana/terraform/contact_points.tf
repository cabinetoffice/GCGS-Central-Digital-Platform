resource "grafana_contact_point" "teams" {
  count = local.teams_webhook_url != "" ? 1 : 0
...
{{ range .Alerts.Firing }}
{{ $service := or (index .Labels "service") (index .Labels "ServiceName") (index .Labels "servicename") (index .Labels "DBInstanceIdentifier") (index .Labels "DBClusterIdentifier") (index .Labels "datasource_uid") (index .Labels "rulename") }}
