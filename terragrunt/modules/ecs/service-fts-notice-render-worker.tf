module "ecs_service_fts_notice_render_worker" {
  source = "../ecs-service"

  container_definitions = templatefile(
    "${path.module}/templates/task-definitions/${var.service_configs.fts_notice_render_worker.name}.json.tftpl",
    local.fts_notice_render_worker_container_parameters
  )
