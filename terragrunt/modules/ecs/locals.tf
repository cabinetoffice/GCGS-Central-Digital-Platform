locals {
  ...
  use_internal_service_urls    = var.use_internal_service_urls != null ? var.use_internal_service_urls : contains(["development", "staging"], var.environment)
  use_internal_issuer          = var.use_internal_issuer != null ? var.use_internal_issuer : contains(["development", "staging"], var.environment)
