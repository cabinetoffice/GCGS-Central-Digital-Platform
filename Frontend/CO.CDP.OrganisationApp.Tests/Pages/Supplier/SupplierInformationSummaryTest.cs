...
public class SupplierInformationSummaryTest
{
    ...
    [
        new(endDate: It.IsAny<DateTimeOffset>(), entityId: Guid.NewGuid(), entityType: ConnectedEntityType.Organisation, name: "e1", uri: It.IsAny<Uri>(), deleted: false),
        new(endDate: It.IsAny<DateTimeOffset>(), entityId: Guid.NewGuid(), entityType: ConnectedEntityType.Organisation, name: "e2", uri: It.IsAny<Uri>(), deleted: false),
    ];
}