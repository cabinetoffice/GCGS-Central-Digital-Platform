...
public class ShareCodesListViewTests
{
    ...
    public async Task MandatorySectionsCompleted_ShouldBeTrue_WhenAllSectionsAreCompleted()
    {
        ...
        _organisationClientMock
            ...
            .ReturnsAsync(new List<ConnectedEntityLookup>() { new ConnectedEntityLookup(endDate: null, entityId: new Guid(), entityType: ConnectedEntityType.Organisation, name: "connected entity name", uri: new Uri("http://whatever"), deleted: false) });
