...
public sealed class OrganisationAdminHandler : AuthorizationHandler<OrganisationAdminRequirement>
{
    private readonly ApiClient.UserManagementClient _apiClient;

    public OrganisationAdminHandler(ApiClient.UserManagementClient apiClient) => _apiClient = apiClient;

    protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, OrganisationAdminRequirement requirement)
    {
