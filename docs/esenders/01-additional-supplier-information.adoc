...
* True values now render as "Yes"
* False values now render as "No"
* Skipped or missing responses render as "Not specified"
* Ensures clearer representation of supplier responses in exported documents
* Existing tests updated and new tests added to cover these cases
* No changes to persisted data or forms engine logic
