...
* *Textual Responses*: Membership numbers, descriptions, some multi-line text

=== Welsh Exclusions Module

* *Policy Answers*: Mix of multi-line text and Yes/No answer
* *Textual Responses*:  Multi-line text descriptions for exclusion details
...
== Production Release – 8th April 2026

=== Summary of Changes
This release introduces updates to Additional Supplier Information (ASI) modules, focusing on Welsh translations and PDF output improvements.

=== New Features / Updates

==== Welsh Translations
Welsh language support added for additional SI modules including:
...
Users can now switch between English and Welsh, with content dynamically updating.

==== PDF Output Improvements
Updated PDF generation logic for Yes/No responses:

* *True values*: Render as "Yes"
* *False values*: Render as "No"
* *Skipped or missing values*: Render as "Not specified"
* *Clarity*: Improved representation of supplier responses in exported documents
* *Testing*: Existing tests updated and new tests added to cover these cases
* *Data impact*: No changes to persisted data or forms engine logic
